...
st.title("Sentiment Analysis of Tweets related to US airlines")
st.sidebar.title("The user dashboard")
st.markdown("This is a Streamlit application used dor analysis of tweets related to US Airlines ")
st.sidebar.markdown("Select the options below to manage the main dashboard")
